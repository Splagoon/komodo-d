# Registers the D language in Komodo.

import logging
from koUDLLanguageBase import KoUDLLanguage

log = logging.getLogger("koDLanguage")
#log.setLevel(logging.DEBUG)

def registerLanguage(registry):
    log.debug("Registering language D")
    registry.registerLanguage(KoDLanguage())

class KoDLanguage(KoUDLLanguage):
    ...
    _reg_clsid_ = "6abe481f-5de4-466f-a192-35f24d6dff26"
    defaultExtension = '.d'
